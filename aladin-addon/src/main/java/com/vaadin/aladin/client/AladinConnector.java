...
@Connect(Aladin.class)
public class AladinConnector extends AbstractComponentConnector {

    // ServerRpc is used to send events to server. Communication implementation
    // is automatically created here
    AladinServerRpc rpc = RpcProxy.create(AladinServerRpc.class, this);

    public AladinConnector() {
        
        // To receive RPC events from server, we register ClientRpc implementation 
        registerRpc(AladinClientRpc.class, Window::alert);
    ...
    @Override
    public AladinWidget getWidget() {
        return (AladinWidget) super.getWidget();
    }

    // We must implement getState() to cast to correct type
    @Override
    public AladinState getState() {
